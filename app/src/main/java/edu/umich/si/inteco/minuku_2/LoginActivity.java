...
public class LoginActivity extends BaseActivity {
    ...
    private class MyAuthResultHandler implements Firebase.AuthResultHandler {
        ...
        public void onAuthenticated(AuthData authData) {
            mAuthProgressDialog.dismiss();
            Log.i(TAG, provider + " Successfully authenticated");
            ...
            if (authData != null) {
                ...
                } else if (authData.getProvider().equals(Constants.GOOGLE_AUTH_PROVIDER)) {
        ...
        userLocationRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    Log.d(TAG, "Setting user value.");
                    User aUser =  dataSnapshot.getValue(User.class);
                    mSharedPref.setUser(aUser);
                }
            }
    ...
    private void setAuthenticatedUserGoogle(AuthData authData) {
        ...
        String[] splitDisplayName = fullNameAsOnGoogleProfile.split(" ");
        final String firstName = splitDisplayName[0];
        ...
        userLocationRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() == null) {
                    User newUser = new User(firstName, lastName, mEmail);
                    userLocationRef.setValue(newUser);
                    mSharedPref.setUser(newUser);
                } else {
                    User existingUser = dataSnapshot.getValue(User.class);
                    mSharedPref.setUser(existingUser);
                }
            }
